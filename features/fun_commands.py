...
ROAST_TEMPLATES = {
    "one_word": [
        ...
        "{name} has sent {count} messages and {pct:.0f}% of them are a single word. We get it, wannabe non chalant over here",
        ...
        "{name} ko lagta hai per-word tax lag raha hai. {pct:.0f}% one-word replies. Pura bol na .",
        "Bhai {name} gunga hai kya? {pct:.0f}% of {count} texts are just one word. Peak  behavior.",
        "Ek word bhej ke cool ban raha hai {name}. {pct:.0f}% one-worders. Typing seekh le ."
    ],
    ...
    "slow_responder": [
        ...
        "{name} takes {resp} to reply. Itni der me toh padosi ka bacha chalna sikh gaya.",
        "Average delay {resp}. Kabutar se letter bhej de {name}, jaldi aayega.",
        "Bhai {name} soch soch ke reply karta hai ya net slow hai? {resp} is crazy."
    ],
    ...
    "ghost": [
        ...
        "{name} taking {resp} to reply. Zinda hai ya nikal gaya?",
        "Bhai {name} ghost kar raha hai {resp} se. Police bulau kya ke liye?",
        "RIP {name}. Last seen active {resp} ago. Gone but not forgotten (except you are)."
    ],
    ...
    "fast_responder": [
        ...
        "{resp} average time! {name} nalla betha hai phone leke, thoda baahar ghum aa.",
        "Itna fast reply {resp} mein? Nalle {name}, koi real job dhundh le.",
        "Bhai {name} screen se chipka hua hai. {resp} me reply kaun karta hai ?"
    ],
    ...
    "caps": [
        ...
        "{name} always shouting like a  in {pct:.0f}% messages. Chilla kyu raha hai ?",
        "Caps lock atak gaya hai kya {name} ka? {pct:.0f}% messages in all caps. Shanti se bol."
    ],
    ...
    "low_effort": [
        ...
        "{name} giving zero effort with {avg_words:.1f} words per message. Keyboard kharab hai ya tu hi aalsi hai ?",
        "Only {avg_words:.1f} words per message. {name} has the personality of a wet cardboard."
    ],
    ...
    "essay_writer": [
        ...
        "{name} casually dropping UPSC level essays with {avg_words:.1f} words/msg. Padhne ka time nahi hai .",
        "Itna lamba kon likhta hai ? {avg_words:.1f} words per message, we ain't reading all that."
    ],
    ...
    "wall_of_text": [
        ...
        "{chars} characters? Bhai {name} thesis likh raha hai gc pe. Get a life.",
        "No one is reading {chars} characters from {name}. Chup kar."
    ],
    ...
    "high_volume": [
        ...
        "{count} messages. {name} ke paas na job hai na izzat. Peak nalla .",
        "{name} single-handedly carrying the chat with {count} messages. Go outside and touch some grass ."
    ],
    ...
    "low_volume": [
        ...
        "Only {count} messages from {name}. Gunga hai ya sirf spy kar raha hai ?",
        "{name} sends {count} messages and dips. Exist bhi karta hai kya tu ?"
    ],
    ...
    "question_spammer": [
        ...
        "Kyu, kya, kaise? {name} asking questions {pct:.0f}% of the time. Google use kar le.",
        "Itne sawaal kyu {name}? {pct:.0f}% questions. Hum tere personal ChatGPT nahi hai."
    ],
    ...
    "exclaimer": [
        ...
        "Har baat pe chillana zaroori hai {name}? {pct:.0f}% exclamation. Relax kar ."
    ],
    ...
    "night_owl": [
        ...
        "{pct:.0f}% messages from 12-5 AM. {name} raat ko ullu ban jata hai, soja .",
        "Raat ke andhere me {name} active hota hai ({pct:.0f}%). Bhoot hai ya sirf vella ?"
    ],
    ...
    "early_bird": [
        ...
        "Subah subah kon bakchodi karta hai? {name} with {pct:.0f}% early morning texts. Soja wapas ."
    ],
    ...
    "weekend_warrior": [
        ...
        "{name} only alive on weekends ({pct:.0f}%). Corporate majdoor saala."
    ],
    ...
    "double_texter": [
        ...
        "Ek baar me type karna nahi aata {name}? {pct:.0f}% double texting. Sabar kar le ."
    ],
    ...
    "repetitive_vocab": [
        ...
        "Sirf {vocab:.0%} vocab richness. {name} ke dimaag me sirf 4-5 words hi hai. NPC ."
    ],
    ...
    "conversation_starter": [
        ...
        "{name} trying to revive dead chats {starts} times. Koi bhav nahi de raha , rehne de ."
    ],
    ...
    "generic": [
        ...
        "{count} messages sent by {name}, aur ek bhi baat dhang ki nahi. Waste of oxygen .",
    ],
}
